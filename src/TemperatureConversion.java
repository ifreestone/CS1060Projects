...
public class TemperatureConversion {
    ...
    public static void main(String[] args) {
        // This sets us up to be able to scan the users input for fahrenheitNum
        Scanner sc = new Scanner(System.in);

        // This outputs the question prompt
        System.out.println("Type in a temperature in Fahrenheit");
        // This scans for the users input
        double fahrenheitNum = sc.nextDouble();
        // This converts the users input into Kelvin
        double kelvinNum = ((fahrenheitNum - 32) * (5.0 / 9)) + 273.15;
        // This converts the users input into Celsius
        double celsiusNum = (fahrenheitNum - 32) * (5.0 / 9);
